package io.github.icodegarden.nursery.springboot.redis.lettuce.autoconfigure;
...
import io.github.icodegarden.nursery.springboot.redis.lettuce.LettuceRedisExecutorBuilder;
...
@Configuration
@Slf4j
public class NurseryRedisLettuceAutoConfiguration {
	...
	public RedisExecutor redisExecutor(NurseryRedisProperties redisProperties) {
		...
		return LettuceRedisExecutorBuilder.create(redisProperties);
	}
